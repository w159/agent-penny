...
{
    "scores": {
        "focus": 0.7, // β / (α + θ) — sustained attention
        "relaxation": 0.4, // α / (β + θ) — calm wakefulness
        "engagement": 0.6, // active mental investment
        ...
        "drowsiness": 0.1, // TAR + TBR + falling spectral centroid
