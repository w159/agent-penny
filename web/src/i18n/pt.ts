...
export const pt: Translations = {
    ...
    pluginsPage: {
        ...
        forceReinstall:
            "Forçar reinstalação (eliminar pasta existente primeiro)",
        headline:
    ...
    skills: {
        title: "Competências",
        searchPlaceholder:
            "Pesquisar competências e conjuntos de ferramentas...",
        ...
        noToolsetsMatch:
            "Nenhum conjunto de ferramentas corresponde à pesquisa.",
    ...
    env: {
        ...
        providersConfigured:
            "{configured} de {total} fornecedores configurados",
        getKey: "Obter chave",
    ...
    kanban: {
        ...
        columnHelp: {
            ...
            scheduled:
                "À espera de um atraso conhecido ou de um seguimento agendado",
