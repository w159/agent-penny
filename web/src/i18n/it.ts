...
export const it: Translations = {
    ...
    skills: {
        ...
        noSkillsMatch:
            "Nessuna competenza corrisponde alla ricerca o al filtro.",
    ...
    oauth: {
        ...
        pasteCode:
            "Incolla codice di autorizzazione (con suffisso #state va bene)",
    ...
    achievements: {
        ...
        empty: {
            no_secrets_header:
                "Nessun segreto nascosto rimasto in questa scansione.",
            no_secrets_body:
    ...
    kanban: {
        ...
        columnHelp: {
            ...
            scheduled:
                "In attesa di un ritardo noto o di un follow-up pianificato",
