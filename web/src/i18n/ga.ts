...
export const ga: Translations = {
    ...
    skills: {
        ...
        noSkillsMatch:
            "Níl scil ar bith ag teacht le do chuardach nó scagaire.",
    ...
    oauth: {
        ...
        pasteCode:
            "Greamaigh an cód údaraithe (tá iarmhír #state ceart go leor)",
        ...
        pkceStep2:
            "Cóipeáil an cód údaraithe a thaispeántar tar éis údaraithe.",
    ...
    kanban: {
        ...
        unblockedMessage:
            "Díbhacadh {id}. Tá an tasc réidh don chéad tic eile.",
        ...
        workspacePathDir:
            "conair workspace (riachtanach, m.sh. ~/projects/my-app)",
