...
export const zhHant: Translations = {
    ...
    pluginsPage: {
        ...
        installHint:
            "可使用 owner/repo 簡寫或完整的 https:// 或 git@ 複製網址。",
        ...
        rescanHint:
            "在磁碟新增檔案後重新掃描，使儀表板側邊欄載入新的 manifest。",
    ...
    config: {
        ...
        confirmResetScope:
            "要將{scope}的所有設定重設為預設值嗎？此操作只更新表單，在按下「儲存」前不會寫入 config.yaml。",
    ...
    oauth: {
        ...
        description:
            "已連線 {connected}/{total} 個 OAuth 提供者。登入流程目前透過 CLI 執行；請點擊「複製指令」並貼到終端機完成設定。",
        connected: "已連線",
        expired: "已過期",
