...
export const fr: Translations = {
    ...
    models: {
        ...
        startSession:
            "Démarrez une session pour voir les données de modèle ici",
    },
    ...
    skills: {
        ...
        noToolsetsMatch:
            "Aucun ensemble d'outils ne correspond à la recherche.",
    ...
    oauth: {
        ...
        pasteCode:
            "Collez le code d'autorisation (avec suffixe #state accepté)",
    ...
    kanban: {
        ...
        workspacePathDir:
            "chemin du workspace (requis, par ex. ~/projects/my-app)",
