...
export const de: Translations = {
    ...
    pluginsPage: {
        ...
        authRequiredHint:
            "Führe diesen Befehl aus, um dich zu authentifizieren:",
        updateGit: "Git pull",
    ...
    skills: {
        ...
        noSkillsMatch:
            "Keine Skills entsprechen deiner Suche oder deinem Filter.",
    ...
    achievements: {
        ...
        empty: {
            no_secrets_header:
                "Keine verborgenen Geheimnisse mehr in diesem Scan.",
            no_secrets_body:
    ...
    kanban: {
        ...
        suspectedHallucinatedReferences:
            "⚠ Text verweist auf Phantom-Karten-IDs",
        ...
        triagePlaceholder:
            "Grobe Idee — die KI wird die Spezifikation erstellen…",
