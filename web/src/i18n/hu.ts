...
export const hu: Translations = {
    ...
    sessions: {
        ...
        failedToDeleteSelected:
            "Nem sikerült törölni a kijelölt munkameneteket",
    ...
    oauth: {
        ...
        pkceStep2:
            "Másolja ki az engedélyezés után megjelenő hitelesítési kódot.",
    ...
    kanban: {
        ...
        sendNotifications:
            "completed / blocked / gave_up értesítések küldése ide:",
        archiveBoardConfirm:
        ...
        unblockedMessage:
            "{id} feloldva. A feladat készen áll a következő tickre.",
        unblockFailed: "Feloldás sikertelen: ",
        reclaimedMessage:
            "{id} visszavéve. A feladat újra ready állapotban van.",
        ...
        workspacePathDir:
            "munkaterület útvonala (kötelező, pl. ~/projects/my-app)",
