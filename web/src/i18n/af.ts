...
export const af: Translations = {
    ...
    skills: {
        ...
        noToolsetsMatch:
            "Geen gereedskapstelle stem ooreen met die soektog nie.",
    ...
    env: {
        ...
        providersConfigured:
            "{configured} van {total} verskaffers gekonfigureer",
        getKey: "Kry sleutel",
    ...
    oauth: {
        ...
        pasteCode:
            "Plak magtigingskode (met #state agtervoegsel is in die haak)",
    ...
    achievements: {
        ...
        empty: {
            no_secrets_header:
                "Geen verborge geheime in hierdie skandering oor nie.",
            no_secrets_body:
    ...
    kanban: {
        ...
        sendNotifications:
            "Stuur completed / blocked / gave_up kennisgewings na",
        archiveBoardConfirm:
        ...
        suspectedHallucinatedReferences:
            "⚠ Teks het na spook-kaart-ID's verwys",
        pickProfileFirst: "Kies eers 'n profiel.",
        unblockedMessage:
            "{id} gedeblokkeer. Taak is gereed vir die volgende tik.",
        ...
        columnHelp: {
            ...
            scheduled:
                "Wag op 'n bekende tydvertraging of geskeduleerde opvolg",
