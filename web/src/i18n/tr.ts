...
export const tr: Translations = {
    ...
    pluginsPage: {
        ...
        openTab: "Aç",
        orphanHeading:
            "Yalnızca pano uzantıları (eşleşen agent plugin.yaml yok)",
    ...
    oauth: {
        ...
        description:
            "{connected}/{total} OAuth sağlayıcısı bağlandı. Giriş akışları şu anda CLI üzerinden çalışır; Komutu kopyala'ya tıklayın ve kurmak için bir terminale yapıştırın.",
        connected: "Bağlandı",
        expired: "Süresi doldu",
        notConnected:
            "Bağlı değil. Bir terminalde {command} komutunu çalıştırın.",
        ...
        pasteCode:
            "Yetkilendirme kodunu yapıştırın (#state ekiyle de olabilir)",
    ...
    kanban: {
        ...
        unblockedMessage:
            "{id} engeli kaldırıldı. Görev sonraki tick için hazır.",
