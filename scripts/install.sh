...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/w159/agent-penny/refs/heads/main/scripts/install.sh | bash
#
# Or with options:
...
# Configuration
REPO_URL_SSH="git@github.com:w159/agent-penny.git"
REPO_URL_HTTPS="https://github.com/w159/agent-penny.git"
...
print_banner() {
    ...
    echo "│             ⚕ Hermes Agent Installer                    │"
    echo "├─────────────────────────────────────────────────────────┤"
    echo "│  An open source AI agent by w159.              │"
    echo "└─────────────────────────────────────────────────────────┘"
    echo -e "${NC}"
}
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/w159/agent-penny/refs/heads/main/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
