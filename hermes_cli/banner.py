...
_UPSTREAM_REPO_URL = "https://github.com/w159/agent-penny.git"
...
_RELEASE_URL_BASE = "https://github.com/w159/agent-penny/releases/tag"
...
def build_welcome_banner(console: "Console", model: str, cwd: str,
    ...
    left_lines.append(f"[{accent}]{model_short}[/]{ctx_str} [dim {dim}]·[/] [dim {dim}]w159[/]")
