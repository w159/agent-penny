...
class DaemonThreadPoolExecutor(ThreadPoolExecutor):
    ...
    def _adjust_thread_count(self) -> None:
        # Mirrors CPython's implementation (3.8-3.13, and separately 3.14+, which
        # replaced the raw (initializer, initargs) pair with a WorkerContext
        # produced by _create_worker_context()) with two changes: daemon=True
        # and no _threads_queues registration.
